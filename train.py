...
train_loader = train_data.to_tf_dataset(batch_size=batch, shuffle=True)
val_data = ImageDataLoader(df=valid_df, images_dir_path="", image_size=size, image_filename_column="pre_processed_file",
                           label_column=["pe_present_on_image",
                                         "rv_lv_ratio_gte_1",
                                         "rv_lv_ratio_lt_1",
                                         "leftsided_pe",
                                         ...
                                         "central_pe",
                                         "indeterminate"], augmenter=None)
val_loader = val_data.to_tf_dataset(batch_size=batch, shuffle=False)
